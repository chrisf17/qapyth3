...
![QA Logo Front Page denoting Python 3 Programming Exercise Guide ](qa_front_page.png)
...
Open expenses01.txt. It contains mileage and expense data in an incosistent data form.
...
1. Open FilesB-Process.py
2. Follow the instruction in the comments

### Challenge 2

1. Open FilesC-Storing.py
2. Follow the instruction in the comments
